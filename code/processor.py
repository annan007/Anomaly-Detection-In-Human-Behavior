...
#To take in arguments of video path and fps
#if fps = 5 then It will extract 1 frame every 5 seconds and store it.
...
for video in videos:
                os.system( 'ffmpeg -i {}/{} -r 30/{}  {}/frames/%04d.jpg'.format(video_source_path,video,fps,video_source_path))
